get222imgmatrix = (scramble) => {
  let cube = {
    up: Array.from({ length: 2 }, () => Array.from({ length: 2 }, () => "w")),
    down: Array.from({ length: 2 }, () => Array.from({ length: 2 }, () => "y")),
    left: Array.from({ length: 2 }, () => Array.from({ length: 2 }, () => "o")),
    right: Array.from({ length: 2 }, () =>
      Array.from({ length: 2 }, () => "r")
    ),
    front: Array.from({ length: 2 }, () =>
      Array.from({ length: 2 }, () => "g")
    ),
    back: Array.from({ length: 2 }, () => Array.from({ length: 2 }, () => "b")),
  };
  ...
  rotate_face_clkwise = (face) => {
    ...
    for (let index = 0; index < 2; index++) {
      face[0][index] = current_face[1 - index][0];
    }

    for (let index = 0; index < 2; index++) {
      face[1][index] = current_face[1 - index][1];
    }
