get777imgmatrix = (scramble) => {
  let cube = {
    up: Array.from({ length: 7 }, () => Array.from({ length: 7 }, () => "w")),
    down: Array.from({ length: 7 }, () => Array.from({ length: 7 }, () => "y")),
    left: Array.from({ length: 7 }, () => Array.from({ length: 7 }, () => "o")),
    right: Array.from({ length: 7 }, () =>
      Array.from({ length: 7 }, () => "r")
    ),
    front: Array.from({ length: 7 }, () =>
      Array.from({ length: 7 }, () => "g")
    ),
    back: Array.from({ length: 7 }, () => Array.from({ length: 7 }, () => "b")),
  };
  ...
  rotate_face_clkwise = (face) => {
    ...
    for (let index = 0; index < 7; index++) {
      face[0][index] = current_face[6 - index][0];
    }

    for (let index = 0; index < 7; index++) {
      face[index][0] = current_face[6][index];
    }

    for (let index = 0; index < 7; index++) {
      face[6][index] = current_face[6 - index][6];
    }

    for (let index = 0; index < 7; index++) {
      face[index][6] = current_face[0][index];
    }

    for (let index = 1; index < 6; index++) {
      face[1][index] = current_face[6 - index][1];
    }

    for (let index = 1; index < 6; index++) {
      face[index][1] = current_face[5][index];
    }

    for (let index = 1; index < 6; index++) {
      face[5][index] = current_face[6 - index][5];
    }

    for (let index = 1; index < 6; index++) {
      face[index][5] = current_face[1][index];
    }

    for (let index = 2; index < 5; index++) {
      face[2][index] = current_face[6 - index][2];
    }

    for (let index = 2; index < 5; index++) {
      face[index][2] = current_face[4][index];
    }

    for (let index = 2; index < 5; index++) {
      face[4][index] = current_face[6 - index][4];
    }

    for (let index = 2; index < 5; index++) {
      face[index][4] = current_face[2][index];
    }
